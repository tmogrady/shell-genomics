...
We've been able to do a lot of work with files that already exist, but what if we want to write our own files? We're not going to type in a FASTA file, but there are a lot of reasons we might want to write a file, or edit an existing file.
