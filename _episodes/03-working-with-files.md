...
> have to interact with directly. The home directory and the root directory are NOT usually the same. Try not to worry if this is confusing,
...
> > 2. Make sure to use an absolute path and a wildcard!
> {: .solution}
{: .challenge}
